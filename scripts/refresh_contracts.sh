...
contracts=("AccountCodeStorage" "BootloaderUtilities" "Compressor" "ComplexUpgrader" "Console" "ContractDeployer" "DefaultAccount" "EmptyContract" "ImmutableSimulator" "KnownCodesStorage" "L1Messenger" "L2EthToken" "MsgValueSimulator" "NonceHolder" "SystemContext" )
